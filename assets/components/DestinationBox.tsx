...
function DestinationBox() {
    ...
    return (
        <View style={{flexDirection: "row" }}>
            ...
            <Animated.View style={[styleSheet.sideContainer, leftContainerStyle, {backgroundColor: "#FF007F", position: "absolute" , left: 0, top: 0, height: "100%"}]}>
            ...
            <Animated.View style={[styleSheet.sideContainer, rightContainerStyle, {backgroundColor: "#FF0000", position: "absolute" , right: 0, top: 0, height: "100%"}]}>
                <Animated.View style={iconStyle}>
                  <Icon
                    name="trash"
                    size={25}
